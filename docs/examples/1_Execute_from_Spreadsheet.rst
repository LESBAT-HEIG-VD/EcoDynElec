| 
| \ **Execution of DYNAMICAL from xlsx spreadsheet**\ 
...
.. code:: ipython3
    ...
    impacts = execute(excel='./Spreadsheet_test.xlsx', is_verbose=True) # Execute DYNAMICAL from spreadsheet
...
.. parsed-literal::
    ...
    Help on function execute in module dynamical.easy_use:
    
    execute(p=None, excel=None, is_verbose=False)
